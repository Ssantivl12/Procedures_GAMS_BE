...
export const PROCEDURE_MESSAGES = {
  ERROR: {
    ...
    MAI_PMA_REQUIRES_RAI: 'MAI-PMA requires at least one closed RAI in this case file',
    IAA_REQUIRES_MAI_PMA: 'IAA requires at least one closed RAI and one closed MAI-PMA in this case file',
